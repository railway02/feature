...
TASK_ROOT="${TASK_ROOT:-$PROJECT/outputs/api_gtmask_roi_cave_v5_fullmask_fullseq/adverse_prepost_series_task_v3}"
MODEL_ROOT="${MODEL_ROOT:-$PROJECT/outputs/api_gtmask_roi_cave_v5_fullmask_fullseq/adverse_prepost_series_formal_models_v31}"
