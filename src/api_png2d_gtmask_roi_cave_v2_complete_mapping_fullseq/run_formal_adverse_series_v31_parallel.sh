...
CODE_DIR="${CODE_DIR:-$PROJECT/code/api_png2d_gtmask_roi_cave_v2_complete_mapping_fullseq}"

TRAIN_XLSX="${TRAIN_XLSX:-$PROJECT/metadata/Train.xlsx}"
VALID_XLSX="${VALID_XLSX:-$PROJECT/metadata/valid.xlsx}"
TABLE_ROOT="${TABLE_ROOT:-$PROJECT/outputs/api_png2d_gtmask_roi_cave_v2_complete_mapping_fullseq/tables/local_eligible}"
MAPPING_DIR="${MAPPING_DIR:-$PROJECT/manifests/api_record_v1_all_series_14e/final_mapping}"

TASK_ROOT="${TASK_ROOT:-$PROJECT/outputs/api_png2d_gtmask_roi_cave_v2_complete_mapping_fullseq/adverse_prepost_series_task_v3}"
MODEL_ROOT="${MODEL_ROOT:-$PROJECT/outputs/api_png2d_gtmask_roi_cave_v2_complete_mapping_fullseq/adverse_prepost_series_formal_models_v31}"
